        ...
        <div className="navbar max-w-screen-xl mx-auto w-full">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow fixed top-0 left-0 right-0"
              >
                {navItems}
              </ul>
            </div>
            <a className="text-2xl font-bold cursor-pointer">The travel Path</a>
          </div>
